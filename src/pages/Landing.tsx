        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center pt-20">
          ...
          >
            <div className="flex flex-wrap items-center justify-center gap-3 mb-8">
              <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm border border-white/20 text-white/90 text-sm px-4 py-2 rounded-full font-medium">
              ...
              <Link
                to="/liveaboard"
                className="inline-flex items-center gap-1.5 bg-purple-400/15 backdrop-blur-sm border border-purple-300/30 text-purple-100 text-sm px-4 py-2 rounded-full font-medium hover:bg-purple-400/25 transition-colors"
              >
                <Home size={14} />
                Liveaboard
                <ArrowRight size={14} />
